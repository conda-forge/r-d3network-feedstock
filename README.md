...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-d3network-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8893&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-d3network-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-d3network` can be installed with:

```
conda install r-d3network
```

It is possible to list all of the versions of `r-d3network` available on your platform with:
